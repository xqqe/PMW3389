...
int Btn_pins[NUMBTN] = { Btn1_Pin};
bool Btns[NUMBTN] = {false};      // button state indicator
uint8_t Btn_buffers[NUMBTN] = {0xFF}; // button debounce buffer
char Btn_keys[NUMBTN] = { MOUSE_LEFT};
